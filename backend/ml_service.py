...
class LogoDetectionService:
    ...
    def update_bbox_thickness(self, thickness: int):
        """Update bounding box thickness"""
        self.bbox_thickness = max(1, min(10, thickness))
        logger.info(f"Updated bounding box thickness to {self.bbox_thickness}")
